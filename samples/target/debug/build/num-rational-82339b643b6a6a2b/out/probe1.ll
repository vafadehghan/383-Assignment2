...
@alloc11 = private unnamed_addr constant <{ [104 x i8] }> <{ [104 x i8] c"C:\5CUsers\5Cv_vaf\5C.rustup\5Ctoolchains\5Cstable-x86_64-pc-windows-msvc\5Clib/rustlib/src/rust\5Csrc\5Cliballoc\5Cvec.rs" }>, align 1
@alloc12 = private unnamed_addr constant <{ i8*, [16 x i8] }> <{ i8* getelementptr inbounds (<{ [104 x i8] }>, <{ [104 x i8] }>* @alloc11, i32 0, i32 0, i32 0), [16 x i8] c"h\00\00\00\00\00\00\00N\09\00\00%\00\00\00" }>, align 8
